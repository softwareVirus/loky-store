...
#product-map-container 
    ProductList(:getRef="getRef" :products="products" :isMobile="minimapContainer")
    .minimap(v-if="minimapContainer")
        ProductListMinimap(
            :getRef="getRef" 
